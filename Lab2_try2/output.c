...
output_results(Simulation_Run_Ptr simulation_run)
{
    ...
    printf("Packet arrivals on Switch 1 = %ld \n", data->arrival_count);
    printf("Packet arrivals on Switch 2 = %ld \n", data->arrival_count2);
    printf("Packet arrivals on Switch 3 = %ld \n\n", data->arrival_count3);

    xmtted_fraction = (double) data->number_of_packets_processed / data->arrival_count;
    xmtted_fraction2 = (double) data->number_of_packets_processed2 / data->arrival_count2;
    xmtted_fraction3 = (double) data->number_of_packets_processed3 / data->arrival_count3;
    ...
    printf("Mean Delay for Origin @ Switch 1(msec) = %.2f \n",
     1e3*data->accumulated_delay/data->number_of_packets_processed);
    printf("Mean Delay for Origin @ Switch 2(msec) = %.2f \n",
     1e3*data->accumulated_delay2/data->number_of_packets_processed2);
    printf("Mean Delay for Origin @ Switch 3(msec) = %.2f \n",
