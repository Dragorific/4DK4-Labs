...
void
transmission_queue_event(Simulation_Run_Ptr, void *);

long int
schedule_transmission_queue_event(Simulation_Run_Ptr, Time, void *);

void
transmission_queue_end_event(Simulation_Run_Ptr, void *);

long int
schedule_transmission_queue_end_event(Simulation_Run_Ptr, Time, void *);
